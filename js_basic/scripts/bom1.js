...
liCls[1].style = 'border-bottom:1px solid pink';
...
title.style = 'background-color:lightgray';
contents[0].style = 'background-color:yellow';
contents[1].style = 'background-color:pink';
